...
<input type="text" name="form" value="CreateNewUserForm" style="visibility: hidden" />
...
<table border="0" cellpadding="4" align="center">
	...
	<tr>
		...
		*</font></span>:</td>
		...
		<td><input type="text" title="Enter Name" id="name" 

name="name" class="mandate"
...
name="name"
	...
	<tr>
		...
		<td><input type="reset" value="Reset" /> &nbsp;&nbsp;<input
			...
			onclick="window.location.href='AdminHome.jsp'" /></td>
	</tr>
</table>
</form>
<br/>
...
<div  id="footer" align="center" style ="position; static: 0; width: 100%; color: #5C1919;" >
