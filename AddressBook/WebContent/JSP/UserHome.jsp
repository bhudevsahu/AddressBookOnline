...
font-size:x-large; color:#5C1919; " align="center" >
            ...
            <hr />       
<%if(session.getAttribute("userid").equals("admin") || session.getAttribute("userid")==null){ %>            
...
&nbsp;&nbsp;1. Search users</a>
<p></p>
<a href="/AddressBook/JSP/UpdateUser.jsp"  style="text-decoration: none;color: black;">&nbsp;&nbsp;
&nbsp;&nbsp;2. Update my details</a>
<p></p>
<a href="/AddressBook/JSP/DeleteConfirm.jsp"  style="text-decoration: none;color: black;">&nbsp;&nbsp;
&nbsp;&nbsp;3. Delete my profile</a>
